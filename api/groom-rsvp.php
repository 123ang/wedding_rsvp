...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (
        ...
        $query = "INSERT INTO rsvps 
                  (name, email, phone, attending, number_of_guests, wedding_type, organization) 
                  VALUES 
                  (:name, :email, :phone, :attending, :number_of_guests, :wedding_type, :organization)";
        ...
        $organization = isset($data->organization) && !empty($data->organization) ? htmlspecialchars(strip_tags($data->organization)) : null;
